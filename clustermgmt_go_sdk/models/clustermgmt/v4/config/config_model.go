 ...
 *
 * Part of the Cluster Management API project
 *
...
/*
  Module clustermgmt.v4.config of Cluster Management API project
*/
package config
import (
  "bytes"
  import2 "github.com/nishantikagarg/sample-go-repo/clustermgmt_go_sdk/v16/models/clustermgmt/v4/error"
  import1 "github.com/nishantikagarg/sample-go-repo/clustermgmt_go_sdk/v16/models/common/v1/response"
  "encoding/json"
  "errors"
  "fmt"
)
...
const(
  ...
  COMPONENTTYPE_UNKNOWN ComponentType = 2
  COMPONENTTYPE_EXTENT_GROUP_REPLICAS ComponentType = 3
  COMPONENTTYPE_OPLOG_EPISODES ComponentType = 4
  COMPONENTTYPE_CASSANDRA_RING ComponentType = 5
  COMPONENTTYPE_ZOOKEPER_INSTANCES ComponentType = 6
  COMPONENTTYPE_FREE_SPACE ComponentType = 7
  COMPONENTTYPE_STATIC_CONFIG ComponentType = 8
  COMPONENTTYPE_ERASURE_CODE_STRIP_SIZE ComponentType = 9
  COMPONENTTYPE_STARGATE_HEALTH ComponentType = 10
)
...
const(
  ...
  DOMAINTYPE_UNKNOWN DomainType = 2
  DOMAINTYPE_DEPRECATED_RACKABLE_UNIT DomainType = 3
  DOMAINTYPE_DEPRECATED_NODE DomainType = 4
  DOMAINTYPE_DEPRECATED_DISK DomainType = 5
  DOMAINTYPE_CUSTOM DomainType = 6
  DOMAINTYPE_DISK DomainType = 7
  DOMAINTYPE_NODE DomainType = 8
  DOMAINTYPE_RACKABLE_UNIT DomainType = 9
  DOMAINTYPE_RACK DomainType = 10
  DOMAINTYPE_CLUSTER DomainType = 11
)
...
type RsyslogModuleItem struct {
  ...
  */
  LogSeverityLevel *int `json:"logSeverityLevel,omitempty"`
  /**
