//Api classes for Cluster Management API project's golang SDK
package api

import (
    "github.com/nishantikagarg/sample-go-repo/clustermgmt_go_sdk/v16/client"
	import1 "github.com/nishantikagarg/sample-go-repo/clustermgmt_go_sdk/v16/models/clustermgmt/v4/config"
	"encoding/json"
	"net/http"
    "net/url"
    "strings"
...
*/
func (api *ClusterApi) GetCluster(clusterExtId string) (*import1.GetClusterResponse, error) {
...
*/
func (api *ClusterApi) GetDomainFaultToleranceStatus(clusterExtId string) (*import1.GetDomainFaultToleranceResponse, error) {
...
*/
func (api *ClusterApi) GetGpuProfiles(clusterExtId string) (*import1.GetGpuProfilesResponse, error) {
...
*/
func (api *ClusterApi) GetHost(clusterExtId string, hostExtId string) (*import1.GetHostResponse, error) {
...
/**
    ...
    -> page_ (int) (optional) : A URL query parameter that specifies the page number of the result set.  Must be a positive integer between 0 and the maximum number of pages that are available for that resource.  Any number out of this range will be set to its nearest bound.  In other words, a page number of less than 0 would be set to 0 and a page number greater than the total available pages would be set to the last page. 
    -> limit_ (int) (optional) : A URL query parameter that specifies the total number of records returned in the result set.  Must be a positive integer between 0 and 100. Any number out of this range will be set to the default maximum number of records, which is 100. 
    -> filter_ (string) (optional) : A URL query parameter that allows clients to filter a collection of resources. The expression specified with $filter is evaluated for each resource in the collection, and only items where the expression evaluates to true are included in the response. Expression specified with the $filter must conform to the OData V4.01 URL conventions. The filter can be applied on following fields: - numberOfVgpusAllocated 
    -> orderby_ (string) (optional) : A URL query parameter that allows clients to specify the sort criteria for the returned list of objects. Resources can be sorted in ascending order using asc or descending order using desc. If asc or desc are not specified the resources will be sorted in ascending order by default. For example 'orderby=templateName desc' would get all templates sorted by templateName in desc order. The orderby can be applied on following fields: - numberOfVgpusAllocated 

    returns: (clustermgmt.v4.config.GetHostGpusResponse, error)
*/
func (api *ClusterApi) GetHostGpus(clusterExtId string, hostExtId string, page_ *int, limit_ *int, filter_ *string, orderby_ *string) (*import1.GetHostGpusResponse, error) {
...
*/
func (api *ClusterApi) GetHostGpusOfCluster(clusterExtId string, page_ *int, limit_ *int, filter_ *string, orderby_ *string) (*import1.GetClusterHostGpusResponse, error) {
...
/**
    ...
    -> page_ (int) (optional) : A URL query parameter that specifies the page number of the result set.  Must be a positive integer between 0 and the maximum number of pages that are available for that resource.  Any number out of this range will be set to its nearest bound.  In other words, a page number of less than 0 would be set to 0 and a page number greater than the total available pages would be set to the last page. 
    -> limit_ (int) (optional) : A URL query parameter that specifies the total number of records returned in the result set.  Must be a positive integer between 0 and 100. Any number out of this range will be set to the default maximum number of records, which is 100. 
    -> filter_ (string) (optional) : A URL query parameter that allows clients to filter a collection of resources. The expression specified with $filter is evaluated for each resource in the collection, and only items where the expression evaluates to true are included in the response. Expression specified with the $filter must conform to the OData V4.01 URL conventions. The filter can be applied on following fields: - bootTimeUsecs - cpuCapacityHz - cpuFrequencyHz - cpuModel - defaultVhdContainerId - defaultVhdContainerUuid - defaultVhdLocation - defaultVmContainerId - defaultVmContainerUuid - defaultVmLocation - gpuDriverVersion - hostName - memorySizeBytes - numberOfCpuCores - numberOfCpuSockets - numberOfCpuThreads 
    -> orderby_ (string) (optional) : A URL query parameter that allows clients to specify the sort criteria for the returned list of objects. Resources can be sorted in ascending order using asc or descending order using desc. If asc or desc are not specified the resources will be sorted in ascending order by default. For example 'orderby=templateName desc' would get all templates sorted by templateName in desc order. The orderby can be applied on following fields: - hostName 

    returns: (clustermgmt.v4.config.GetHostsResponse, error)
*/
func (api *ClusterApi) GetHosts(clusterExtId string, page_ *int, limit_ *int, filter_ *string, orderby_ *string) (*import1.GetHostsResponse, error) {
...
*/
func (api *ClusterApi) GetRackableUnits(clusterExtId string) (*import1.GetRackableUnitsResponse, error) {
...
*/
func (api *ClusterApi) GetRsyslogServers(clusterExtId string) (*import1.GetRsyslogServersResponse, error) {
...
*/
func (api *ClusterApi) GetSnmp(clusterExtId string) (*import1.GetSnmpResponse, error) {
