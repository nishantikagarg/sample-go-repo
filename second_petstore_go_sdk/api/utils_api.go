...
import (
    "github.com/nishantikagarg/sample-go-repo/second_petstore_go_sdk/client"
	import2 "github.com/nishantikagarg/sample-go-repo/second_petstore_go_sdk/models/petstore/v1/utils"
	"reflect"
	"encoding/json"
	"net/http"
    "net/url"
