//Api classes for Second petstore's golang SDK
package api

import (
    "github.com/nishantikagarg/sample-go-repo/second_petstore_go_sdk/v1/client"
	"reflect"
	import2 "github.com/nishantikagarg/sample-go-repo/second_petstore_go_sdk/v1/models/petstore/v1/utils"
	"encoding/json"
	"net/http"
    "net/url"
    "strings"
...
/**
    Verifies repeated model names

    parameters:-
    -> body (petstore.v1.utils.Echo) (required) : Echo Payload

    returns: (petstore.v1.utils.CreateEchoResponse, error)
*/
func (api *UtilsApi) CreateEcho(body *import2.Echo) (*import2.CreateEchoResponse, error) {
    uri := "/petstore/v1.0.a1/utils/echo"
    ...
    unmarshalledResp := new(import2.CreateEchoResponse)
