...
/*
  Module common.v1.response of Petstore API project
*/
package response
import (
  import1 "github.com/nishantikagarg/sample-go-repo/second_petstore_go_sdk/v1/models/common/v1/config"
)
...
/**
A model that represents an object instance that is accessible via an API endpoint.  Instances of this type get an extId field which contains the globally unique identifier for that instance.  Externally accessible instances are always tenant aware and therefor extend the TenantAwareModel
*/
