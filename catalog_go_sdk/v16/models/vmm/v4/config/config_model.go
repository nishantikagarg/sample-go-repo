...
/*
  Module vmm.v4.config of Catalog REST API
*/
package config
import (
  "bytes"
  import1 "github.com/nishantikagarg/sample-go-repo/catalog_go_sdk/v16/v16/models/common/v1/config"
  import2 "github.com/nishantikagarg/sample-go-repo/catalog_go_sdk/v16/v16/models/common/v1/response"
  "encoding/json"
  "errors"
  "fmt"
)
...
func (p *OneOfVMTemplateGuestCustomizationConfig) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case Sysprep:
      if nil == p.oneOfType0 {p.oneOfType0 = new(Sysprep)}
    ...
    case CloudInit:
      if nil == p.oneOfType1 {p.oneOfType1 = new(CloudInit)}
...
func (p *OneOfCloudInitConfig) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case import1.KVPair:
      if nil == p.oneOfType1 {p.oneOfType1 = new(import1.KVPair)}
    ...
    case CloudInitDataSource:
      if nil == p.oneOfType0 {p.oneOfType0 = new(CloudInitDataSource)}
...
func (p *OneOfVMTemplateBootDeviceConfig) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    case VMTemplateDiskAddress:
      if nil == p.oneOfType0 {p.oneOfType0 = new(VMTemplateDiskAddress)}
      ...
      *p.ObjectType_ = *p.oneOfType0.ObjectType_
    case NicMacAddress:
      if nil == p.oneOfType1 {p.oneOfType1 = new(NicMacAddress)}
...
func (p *OneOfSysprepConfig) SetValue (v interface {}) error {
  ...
  switch v.(type) {
    ...
    case SysprepUnattendXml:
      if nil == p.oneOfType0 {p.oneOfType0 = new(SysprepUnattendXml)}
